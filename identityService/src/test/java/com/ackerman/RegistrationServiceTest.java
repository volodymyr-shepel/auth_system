...
//
//        // Act
//        ResponseEntity<Integer> response = registrationService.register(appUserDTO, model);
//
//        // Assert
...
//
//        // Act and Assert
//        assertThrows(PasswordValidationException.class, () -> registrationService.register(appUserDTO, model));
